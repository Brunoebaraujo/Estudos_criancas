...
- 24 desafios novos de Português concentrados em verbo haver, transitividade, concordância, interpretação, citação e coordenação.
...
- `content/recportfoco2tri26.ts`: reforço curto e direcionado de Língua Portuguesa.
